...
namespace backend.Controllers
{
    ...
    public class ProdutoController: ControllerBase
    {
        ...
        public async Task<ActionResult<List<Produto>>> Get(){
            var Produtos = await _contexto.Produto.Include("IdSobreProdutoNavigation").ToListAsync();
        ...
        public async Task<ActionResult<Produto>> Get(int id){
            var Produto = await _contexto.Produto.Include("IdSobreProdutoNavigation").FirstOrDefaultAsync(e => e.IdProduto == id);
